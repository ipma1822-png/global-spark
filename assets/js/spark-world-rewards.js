// GLOBAL SPARK · GAMEIFICATION 10/13 · reward animation + sound events
(function(){
 const reduce=matchMedia('(prefers-reduced-motion: reduce)').matches;
 const sound=type=>document.dispatchEvent(new CustomEvent('spark-world:sound',{detail:{type}}));
